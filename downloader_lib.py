...
async def _download_instagram_post_async(url: str, session_dir: str) -> List[str] | None:
...
def _download_instagram_post_sync(url: str, session_dir: str):
    ...
    try:
        ...
        print("ERROR: Сесія Instaloader недійсна або відсутня. Запустіть 'instaloader --login=YOUR_USERNAME'")
        raise
...
async def _download_with_yt_dlp(url: str, session_dir: str, audio_only: bool, format_id: str | None) -> List[str] | None:
